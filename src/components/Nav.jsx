                                ...
                                <div>
                                    <div className='slideBar' style={{ display: 'flex' }}>
                                        <div className='sideCont'>
                                            ...
                                            <Typography variant="h6" noWrap style={{ color: "black", marginTop: '7px', marginLeft: '36px' }}>
                                                Note
                                        </Typography></div>
                                        <div className='sideCont'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" >
                                            ...
                                            <Typography variant="h6" noWrap style={{ color: "black", marginLeft: '36px', marginBottom: '7px' }}>
                                                Remainder
                                        </Typography></div>
                                        <Divider />
                                        ...
                                        <div>
                                        {
                                            this.state.labels.map(label =>
                                                <div className='sideCont' key={label.labelId}>
                                                    ...
                                                    <Typography variant="h6" noWrap style={{ color: "black", marginLeft: '36px' }} >
                                                        {label.labelName}
                                                    </Typography>
                                                </div>
                                        )}
                                        ...
                                        <div className='sideCont' style={{color:'black', justifyContent:'center', marginTop:'-2px'}}>Privacy · Terms 
                                        Open-source licenses</div>
                                    </div>
                                </div> : null
                        }
